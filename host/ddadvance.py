        ...
        if deltaStartSpeedS:
            ...
            for dim in range(5):
                if deltaSpeedV[dim] != 0:
                    ...
                    if (dimAccel / ren_DEFAULT_MAX_ACCELERATION[dim]) > 1.001:
                        print "dim %d verletzt max accel: " % dim, dimAccel, " > ", ren_DEFAULT_MAX_ACCELERATION[dim]
                        assert(0)
            #end debug
        ...
        if deltaEndSpeedS:
            ...
            for dim in range(5):
                if deltaSpeedV[dim] != 0:
                    ...
                    if (dimDeccel / ren_DEFAULT_MAX_ACCELERATION[dim]) > 1.001:
                        print "dim %d verletzt max accel: " % dim, dimDeccel, " [mm/s] > ", ren_DEFAULT_MAX_ACCELERATION[dim], " [mm/s]"
                        assert(0)
            # end debug
